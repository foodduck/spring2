	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".cancel_btn").on("click", function(){
				...
				location.href = "/board/boardReadView?bno=${boardUpdate.bno}"
					   + "&page=${scri.page}"
			...
			$(".update_btn").on("click", function(){
				...
				formObj.attr("action", "/board/boardUpdate");
	...
	<body>
		...
		<div id="root">
			...
			<section id="container">
				<form name="updateForm" role="form" method="post" action="/board/boardUpdate" enctype="multipart/form-data">
